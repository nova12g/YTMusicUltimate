// VolumeBoost.x  —  drop-in feature for YTMusicUltimate
// (.x, not .xm: the Makefile globs `Source/*.x` at the top level. This is
//  plain Objective-C — no C++ — so .x is correct. See VolumeBoost.h.)
//
